...
export default function BossSidebar({ activeTab, onTabChange, onLogout, user, setSidebarOpen }) {
      ...
      <div className="p-5 border-b border-gray-200">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            ...
            <p className="text-xs font-medium text-indigo-600">Boss Access</p>
          </div>
        </div>
      </div>
          ...
          <div className="p-4 bg-gradient-to-r from-indigo-50 to-purple-50 border-b border-gray-100">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl w-12 h-12 flex items-center justify-center shadow-md ring-4 ring-indigo-100">
              ...
              <div className="ml-4">
                <p className="text-lg font-bold text-gray-900">Boss</p>

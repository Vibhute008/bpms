...
export default function AccountantSidebar({ activeTab, onTabChange, onLogout, user }) {
      ...
      <div className="p-5 border-b border-gray-200">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            ...
            <p className="text-xs font-medium text-indigo-600">Accountant Access</p>
          </div>
        </div>
      </div>
          ...
          <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-gray-100">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl w-12 h-12 flex items-center justify-center shadow-md ring-4 ring-green-100">
              ...
              <div className="ml-4">
                <p className="text-lg font-bold text-gray-900">Accountant</p>
